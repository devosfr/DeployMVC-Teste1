...
public class ControleFrete2
{
    ...
    public static IList<FreteDTO> GetOpcoesFreteEndereco(String cepCliente)
    {
        //if (modoEnvio == null)
        //    return null;
    ...
    public static IList<FreteDTO> GetOpcoesFreteDetalhe(String cepCliente, int idProduto, int idTamanho)
    {
        //if (modoEnvio == null)
        //    return null;
