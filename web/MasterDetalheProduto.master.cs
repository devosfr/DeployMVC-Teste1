...
public partial class MasterPage : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //{
            //    DadoVO dado = MetodosFE.getTela("Modal Home");
            //    Cliente cliente = ControleLoginCliente.GetClienteLogado();

            //    if (dado != null && Session["Modal"]==null)
            //    {
            //        if (cliente == null || !cliente.ParticipanteBonificacao)
            //            if (dado.visivel)
            //            {
            //                mostrarModal = true;
            //                Session["Modal"] = true;
            //                litTextoPopUp.Text = dado.descricao;
            //            }
