<%@ Page Language="C#" MasterPageFile="~/Controle/GerenciadorNovo.master" AutoEventWireup="true" CodeFile="Bairros.aspx.cs" Inherits="Controle_Cadastro_Estado" Title="Acabamentos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphConteudo" runat="Server">
    ...
    <div id="divDados" runat="server" clientidmode="Static">
        ...
        <ul>
            ...
            <li>
                <asp:Label ID="Label2" runat="server" CssClass="nomeCampo" Text="Nome:"></asp:Label>
            ...
            <li>
                ...
                <asp:DropDownList ID="ddlEstado" runat="server" Width="220px" AutoPostBack="true" OnSelectedIndexChanged="ddlEstado_SelectedIndexChanged">
            ...
            <li>
                ...
                <asp:DropDownList ID="ddlCidade" runat="server" Width="220px">
                    <asp:ListItem Text="Selecione" Value=""></asp:ListItem>
                </asp:DropDownList>
            ...
            <div class="idResultado">
                <asp:GridView ID="gvObjeto" runat="server" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cidade" SortExpression="">
                            <ItemTemplate>
                                <%# ((Modelos.Bairro)Container.DataItem).Cidade.Nome%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Estado" SortExpression="">
                            <ItemTemplate>
                                <%# ((Modelos.Bairro)Container.DataItem).Cidade.Estado.Nome%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="btnCancel" CausesValidation="False" ImageUrl="~/Controle/comum/img/BotoesGrid/icoExcluir.jpg"
                                    OnClientClick="return confirm('Deseja mesmo apagar este bairro, apagando ele e todos os itens relacionados?')" CommandName="Delete"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
