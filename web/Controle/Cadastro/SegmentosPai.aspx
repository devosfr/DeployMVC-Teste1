<%@ Page Title="" Language="C#" MasterPageFile="~/Controle/GerenciadorNovo.master" AutoEventWireup="true"
    CodeFile="SegmentosPai.aspx.cs" Inherits="Controle_Cadastro_SegmentoPai" %>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<%@ Register Src="~/Controle/Cadastro/uplSegPai.ascx" TagPrefix="uc1" TagName="uplSegPai" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphConteudo" runat="Server">
    ...
    <div id="divDados" runat="server" clientidmode="Static">
        ...
        <ul>
            ...
            <li>
                <uc1:uplSegPai runat="server" ID="uplSegPai" />
            </li>
        </ul>
        <div>
                ...
                <asp:GridView ID="gvSegmento" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Visível" SortExpression="visivel">
                            <ItemTemplate>
                                <%# ((Modelos.SegmentoPaiVO)Container.DataItem).visivel ? "Sim" : "Não"%>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="btnCancel" CausesValidation="False" ImageUrl="~/Controle/comum/img/BotoesGrid/icoExcluir.jpg"
                                    OnClientClick="return confirm('Deseja mesmo apagar este segmento pai, incluindo todos os segmentos filho, todas as categorias, produtos, e demais itens relacionados?')" CommandName="Delete"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
