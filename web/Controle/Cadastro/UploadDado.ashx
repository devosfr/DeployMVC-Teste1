...
public class Upload : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    private Repository<ImagemDadoVO> repoFotoDado
    {
        get
        {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            IList<ImagemDadoVO> colecaofotos = repoFotoDado.All().Where(x => x.dado.Id == idProduto).ToList();
    ...
    public void upload(int idCodigo, string tmpFoto, string nome, int contagem = 1)
    {
        ...
        if (idCodigo != 0)
        {
            ...
            DadoVO dado = repoDado.FindBy(idCodigo);

            FileInfo arquivo = new FileInfo(tmpFoto);
                
            ImagemDadoVO foto = new ImagemDadoVO();
            
            foto.dado = dado;
            foto.Ordem = 0;
            repoFotoDado.Add(foto);
            foto.Nome = idProduto + "-" + dado.chave + "-" + foto.Id + arquivo.Extension;
