<%@ Page Language="C#" MasterPageFile="~/Controle/GerenciadorNovo.master" AutoEventWireup="true" CodeFile="Categoria.aspx.cs" Inherits="Controle_Cadastro_Estado" Title="Acabamentos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphConteudo" runat="Server">
    ...
    <div id="divDados" runat="server" clientidmode="Static">
        ...
        <ul>
            ...
            <li>
                <span class="nomeCampo">Segmento:</span>
                <asp:DropDownList runat="server" ID="ddlSegmento" AutoPostBack="true" OnSelectedIndexChanged="ddlSegmento_SelectedIndexChanged">
                </asp:DropDownList>
            </li>
            <li>
                <span class="nomeCampo">SubSegmento:</span>
                <asp:DropDownList runat="server" ID="ddlSubSegmento">
                </asp:DropDownList>
            </li>
        </ul>
        <div>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="btnCancel" CausesValidation="False" ImageUrl="~/Controle/comum/img/BotoesGrid/icoExcluir.jpg"
                                    OnClientClick="return confirm('Deseja mesmo apagar esta categoria?')" CommandName="Delete"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
