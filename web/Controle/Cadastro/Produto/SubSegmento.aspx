<%@ Page Language="C#" MasterPageFile="~/Controle/GerenciadorNovo.master" AutoEventWireup="true" CodeFile="SubSegmento.aspx.cs" Inherits="Controle_Cadastro_Estado" Title="Acabamentos" %>
            ...
            <div class="idResultado">
                <asp:GridView ID="gvObjeto" runat="server" AllowPaging="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Segmento" SortExpression="Segmento.id">
                            <ItemTemplate>
                                <%# ((SubSegmentoProduto)Container.DataItem).Segmento.Nome %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="btnCancel" CausesValidation="False" ImageUrl="~/Controle/comum/img/BotoesGrid/icoExcluir.jpg"
                                    OnClientClick="return confirm('Deseja mesmo apagar este segmento, apagando ele e todas as categorias relacionadas?')" CommandName="Delete"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
