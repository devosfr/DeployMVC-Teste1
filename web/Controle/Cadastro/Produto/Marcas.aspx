<%@ Page Language="C#" MasterPageFile="~/Controle/GerenciadorNovo.master" AutoEventWireup="true" CodeFile="Marcas.aspx.cs" Inherits="Controle_Cadastro_Estado" Title="Acabamentos" %>

<%@ Register Src="~/Controle/Cadastro/uplMarca.ascx" TagPrefix="uc1" TagName="uplCor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphConteudo" runat="Server">
    ...
    <div id="divDados" runat="server" clientidmode="Static">
        <ul>
            ...
            <li>
                <span class="nomeCampo">Código da Cor:</span>
                <asp:TextBox ID="txtCodigoCor" runat="server" Width="220px" AutoCompleteType="Disabled"></asp:TextBox>
            </li>
            <li>
                <uc1:uplCor runat="server" ID="uplCor" />
            </li>
        </ul>
        <div>
        ...
        <div class="idFiltro clearfix">
            ...
            <div class="idResultado">
                <asp:GridView ID="gvObjeto" runat="server" AllowPaging="True"
                    ...
                    EmptyDataText="Não existe dados." PageSize="500" ForeColor="Black" GridLines="Both"
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="btnCancel" CausesValidation="False" ImageUrl="~/Controle/comum/img/BotoesGrid/icoExcluir.jpg"
                                    OnClientClick="return confirm('Deseja mesmo apagar esta cor, apagando ele e todos os itens relacionados?')" CommandName="Delete"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
