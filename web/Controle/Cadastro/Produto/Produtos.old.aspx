<%@ Page Title="" Language="C#" MasterPageFile="~/Controle/GerenciadorNovo.master"
    AutoEventWireup="true" CodeFile="Produtos.old.aspx.cs" Inherits="Controle_Cadastro_produtos" %>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<%@ Register Src="~/Controle/Cadastro/uplProduto.ascx" TagPrefix="uc1" TagName="uplImagemProduto" %>
    ...
    <div id="divDados" runat="server" clientidmode="Static">
        ...
        <div id="divCores">
               ...
               <div>    
                        Cores:
                    <div>
                        <asp:TreeView CollapseImageUrl="~/Controle/comum/img/ic_menos.gif" NoExpandImageUrl="~/Controle/comum/img/tvSubItemAtivo.gif" ExpandImageUrl="~/Controle/comum/img/ic_mais.gif" runat="server" ShowCheckBoxes="All" ID="treViewCores"></asp:TreeView>
                    </div>
</div>
         <uc1:uplImagemProduto runat="server" ID="uplImagemProduto" />
