        ...
        <div class="baner-topo" style="background-image: url('<%= MetodosFE.BaseURL %>/assets/img/fundo-menu-topo.jpg');height:120px;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs pull-right" style="margin-top:30px;text-align:right;">
                       <a href="#" id="lkfonewhats" runat="server" target="_blank" class="btn btn-lg btnland"><strong><asp:Literal runat="server" ID="litfoneTopo"></asp:Literal></strong><img src="<%= MetodosFE.BaseURL %>/assets/img/whatts-land.png" style="height:22px;width:22px;margin-left:8px;" /></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 titulo-carrossel">
                        <h2><span style="color:#F9c300;"><asp:Literal runat="server" ID="litTitulo"></asp:Literal></span>
                        </h2>
                        <span style="color:#FFFFFF;"><asp:Literal runat="server" ID="litTexto"></asp:Literal>
                        </span>
                    </div>
                    <!--FORMULARIO-->
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding formulario-kemp">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mensagem">
                                <asp:Literal runat="server" ID="litSucesso"></asp:Literal> <span> <asp:Literal runat="server" ID="litErro"></asp:Literal> </span>
                            </div>
                                ...
                                <ul class="whats hidden-lg hidden-md">
                                    <li>
                                        <a href="#" runat="server" target="_blank" class="whats" id="linkWhats2">
                                            <asp:Literal runat="server" ID="litWhats2"></asp:Literal>
                                        </a>
                                    </li>
                                    <li>
