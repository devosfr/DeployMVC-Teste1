<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Carrinho2.aspx.cs" Inherits="_carrinho" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="background-color: #fff">
        ...
        <!--fim CAMINHO-->
        <div class="container fundo-branco" ng-app="carrinhoApp" ng-cloak>
                                        ...
                                        <tbody ng-cloak>
                                            <tr ng-repeat="itemCarrinho in carrinho">
                                                <td class="product-in-table">
                                                    <img class="img-responsive" style="height:130px" src='{{itemCarrinho.ImagemProduto}}' alt="{{itemCarrinho.NomeProduto}}">
                                                    <div class="product-it-in">
                                                        <h3 class="cor-textos-carrinho">{{itemCarrinho.NomeProduto}}</h3>
                                                        <div class="cor-textos-carrinho">{{itemCarrinho.DescricaoProduto}}</div>
                                                    </div>
                                                </td>
                                                <td class="cor-textos-carrinho">{{itemCarrinho.PrecoProduto | currency: 'R$ ' : 2}}</td>
                                                <td>
                                                    <button type='button' class="quantity-button" name='subtract'
                                                         ng-click="decrementaQuantidade(itemCarrinho)" value='-' >-</button>
                                                    <input type='text' class="quantity-field ng-pristine ng-valid ng-touched" name='qty1' ng-model="itemCarrinho.Quantidade" ng-change="programaAtualizacao()" 
                                                        value="5" id='qty1'/>
                                                    <button type="button" class="quantity-button" name="add" ng-click="incrementaQuantidade(itemCarrinho)" value="+">+</button>
                                                    <%--<button type='button' class="quantity-button" name='add' ng-click="incrementaQuantidade(itemCarrinho)" value='+' style="background-color:#000">+</button>--%>

                                                </td>
                                                <td class="shop-red cor-textos-carrinho">{{itemCarrinho.PrecoProduto * itemCarrinho.Quantidade| currency: 'R$ ' : 2}}</td>
